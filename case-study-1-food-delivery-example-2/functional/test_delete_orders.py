...
def test_delete_orders():
    order_amount = 15.89 
    response = requests.delete("{}/orders/10".format(helper.get_service_url('orders')), timeout=helper.get_timeout('orders'), json={"order_id": 1234, "order_amount": order_amount})

...
FilibusterRequestsInstrumentor().instrument(
    service_name="takeout_auth", filibuster_url=helper.get_service_url("filibuster")
)
...
if __name__ == "__main__":
    app.run(
        port=helper.get_port("takeout_auth"), host="0.0.0.0", debug=helper.get_debug()
    )

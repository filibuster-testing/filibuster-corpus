...
helper = helper.Helper("case-study-2-food-delivery-example-e")
...
def create_order():
    ...
    return rpc_auth_create("POST", data["order_type"], order_details)
...
def update_order():
    ...
    return rpc_auth_update("PUT", data["order_type"], order_details)
...
def delete_order():
    ...
    return rpc_auth_delete("DELETE", data["order_type"], order_details)
...
def rpc_auth(verb, order_type, order_details):
    ...
    try:
        ...
        response = requests.request(
            verb,
            "{}/{}".format(helper.get_service_url("auth"), str(order_type) + "_auth"),

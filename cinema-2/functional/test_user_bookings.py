...
def test_functional_cinema_2_user_user_bookings():
    ...
    if users_bookings.status_code == 200:
        assert (not helper.fault_injected()) and users_bookings.json() == {'20151201': [{'rating': 8.8,'title': 'Creed','uri': '/movies/267eedb8-0f5d-42d5-8f43-72426b9fb3e6'}]}
    else:
        assert helper.fault_injected() and users_bookings.status_code in [503, 404]

if __name__ == "__main__":
    test_functional_cinema_2_user_user_bookings()
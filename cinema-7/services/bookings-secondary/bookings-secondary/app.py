...
jaeger_exporter = jaeger.JaegerSpanExporter(
    service_name="bookings-secondary",
...
FilibusterRequestsInstrumentor().instrument(service_name="bookings-secondary", filibuster_url=helper.get_service_url('filibuster'))

from filibuster.instrumentation.flask import FlaskInstrumentor as FilibusterFlaskInstrumentor
FilibusterFlaskInstrumentor().instrument_app(app, service_name="bookings-secondary", filibuster_url=helper.get_service_url('filibuster'))

...
def test_functional_cinema_8_user_user_bookings():
    users_bookings = requests.get("{}/users/{}/bookings".format(helper.get_service_url('api-server'), 'chris_rivers'), timeout=helper.get_timeout('api-server'))
...
if __name__ == "__main__":
    test_functional_cinema_8_user_user_bookings()

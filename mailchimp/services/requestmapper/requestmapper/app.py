...
FilibusterRequestsInstrumentor().instrument(service_name="requestmapper", filibuster_url=helper.get_service_url('filibuster'))

from filibuster.instrumentation.flask import FlaskInstrumentor as FilibusterFlaskInstrumentor
FilibusterFlaskInstrumentor().instrument_app(app, service_name="requestmapper", filibuster_url=helper.get_service_url('filibuster'))
